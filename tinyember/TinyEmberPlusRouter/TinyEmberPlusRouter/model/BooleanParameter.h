...
#ifndef __TINYEMBERROUTER_MODEL_BooleanParameter_H
#define __TINYEMBERROUTER_MODEL_BooleanParameter_H
...
namespace model
{
   ...
   public:
      /**
        * Creates a new instance of BooleanParameter.
        ...
        */
      BooleanParameter(int number, Element* parent, std::string identifier, NotificationSink* notificationSink);
...
#endif//__TINYEMBERROUTER_MODEL_BooleanParameter_H
